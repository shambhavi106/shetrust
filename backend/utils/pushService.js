...
const VAPID_SUBJECT     = process.env.VAPID_SUBJECT     || 'mailto:shetrust@example.com';
...
async function sendEmail({ to, subject, html, text }) {
  ...
  try {
    ...
    await transporter.sendMail({
      from: process.env.SMTP_FROM || '"SheTrust" <noreply@shetrust.app>',
...
<body><div class="wrap">
  <div class="logo">🛡️ SheTrust</div>
  <div class="card">
    <div class="title">${notif.title}</div>
    <div class="body">${notif.body.replace(/\n/g,'<br>')}</div>
    ${notif.url ? `<a href="https://shetrust.app${notif.url}" class="cta">View on SheTrust →</a>` : ''}
  </div>
  <div class="footer">
    You're receiving this because you have alerts enabled for SheTrust.<br>
